...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const baseStyles = "h-14 font-bold text-lg uppercase tracking-wider rounded transition-all duration-200 active:scale-95 flex items-center justify-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg";
